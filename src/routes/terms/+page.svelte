...
<div class="mx-auto max-w-4xl px-6 py-12">
  <h1 class="mb-2 text-3xl font-bold text-gray-100">Terms and Conditions</h1>
  ...
  <div class="space-y-8 text-gray-300">
    ...
    <section>
      ...
      <ul class="ml-6 list-disc space-y-2">
        <li>
          <strong class="text-gray-100">Affiliate</strong> means an entity that controls, is controlled by or is under common
        ...
        <li><strong class="text-gray-100">Country</strong> refers to: United Kingdom.</li>
        <li>
          <strong class="text-gray-100">Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
          Agreement) refers to NordStack Ltd, 71-75 Shelton Street, Covent Garden, London WC2H 9JQ, United Kingdom.
        </li>
        <li>
    ...
    <section>
      <h2 class="mb-4 text-xl font-semibold text-gray-100">Acknowledgment</h2>
      <p>
    ...
    <section>
      <h2 class="mb-4 text-xl font-semibold text-gray-100">User Accounts</h2>
      <p>
    ...
    <section>
      <h2 class="mb-4 text-xl font-semibold text-gray-100">Termination</h2>
      <p>
    ...
    <section>
      <h2 class="mb-4 text-xl font-semibold text-gray-100">Limitation of Liability</h2>
      <p>
    ...
    <section>
      <h2 class="mb-4 text-xl font-semibold text-gray-100">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
      <p>
    ...
    <section>
      <h2 class="mb-4 text-xl font-semibold text-gray-100">Governing Law</h2>
      <p>
    ...
    <section>
      <h2 class="mb-4 text-xl font-semibold text-gray-100">Disputes Resolution</h2>
      <p>
    ...
    <section>
      <h2 class="mb-4 text-xl font-semibold text-gray-100">For European Union (EU) Users</h2>
      <p>
    ...
    <section>
      <h2 class="mb-4 text-xl font-semibold text-gray-100">Translation Interpretation</h2>
      <p>
    ...
    <section>
      <h2 class="mb-4 text-xl font-semibold text-gray-100">Changes to These Terms and Conditions</h2>
      <p>
