...
A real-time collaborative presentation editor with presenter mode.

## Features

- Rich text editor with headings, lists, images, blockquotes
- Real-time collaboration via WebRTC (peer-to-peer sync)
...
- **Collaboration**: Yjs, y-prosemirror, y-webrtc
...
- y-webrtc enables peer-to-peer sync without a central server
- Documents persist to PostgreSQL for durability
