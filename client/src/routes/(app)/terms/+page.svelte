...
<div class="mx-auto max-w-4xl px-6 py-12">
  <h1 class="mb-2 text-3xl font-bold">Terms and Conditions</h1>
    ...
    <section>
      ...
      <ul>
        ...
        <li>
          ...
          NordStack Ltd, 71-75 Shelton Street, Covent Garden, London WC2H 9JQ, United Kingdom.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Chapel Screen, accessible from
